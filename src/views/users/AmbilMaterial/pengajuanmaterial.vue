        ...
        <div class="grid grid-rows-1 gap-2 w-[100%] md:w-[80%]">
          <div class="grid grid-cols-2 gap-2">
            ...
            <div class="flex flex-col text-[12px] gap-1">
              ...
              <input
                v-model="mobilStore.waktu"
                class="rounded-lg w-[30%] h-[3vmax] px-3 border border-[#D9D9D9]"
                type="time"
                required
              />
            </div>
