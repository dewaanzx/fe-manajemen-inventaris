  ...
  <article>
    ...
    >
      ...
      <div class="h-[5vmin] flex flex-row justify-between items-center">
        ...
        >
        <button
          @click="$router.push('/admin/konfirmasi-ruangan/konfirmasi/' + room_transaction.id)"
...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    ...
    roomTransactionStore.fetchByStatus("Dicek").then(() => {
      next(vm => {
        vm.status = status;
