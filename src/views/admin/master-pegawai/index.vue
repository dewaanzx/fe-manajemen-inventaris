  ...
  <section>
    <article class="mt-4">
      <div class="md:flex md:flex-row-reverse md:justify-end md:gap-3">
        ...
        <button
          @click="$router.push('/admin/master-pegawai/tambah')"
        ...
        <div class="w-full overflow-auto touch-auto ...">
          <table class="w-full my-3">
            ...
            <tr v-for="room in paginatedRooms" class="text-[12px] md:text-[14px] border-b">
              ...
              >
                <button @click="$router.push('/admin/master-pegawai/edit/' + room.id)" class="bg-blue-400 text-white rounded-md">Edit</button>
                <button @click="$router.push('/admin/master-pegawai/detail/' + room.id)" class="bg-gray-400 text-white rounded-md">
                  Detail
                </button>
