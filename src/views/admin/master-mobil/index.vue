  ...
  <section>
    <article class="mt-4">
      <div class="md:flex md:flex-row-reverse md:justify-end md:gap-3">
        ...
        <button
          @click="$router.push('/admin/master-mobil/tambah')"
        ...
        <div class="w-full overflow-auto touch-auto ...">
          <table class="w-full my-3">
            ...
            <tr v-for="car in paginatedCars" class="text-[12px] md:text-[14px] border-b">
              ...
              >
                <button @click="$router.push('/admin/master-mobil/edit/' + car.id)" class="bg-blue-400 text-white rounded-md">Edit</button>
                <button @click="$router.push('/admin/master-mobil/detail/' + car.id)" class="bg-gray-400 text-white rounded-md">
                  Detail
                </button>
