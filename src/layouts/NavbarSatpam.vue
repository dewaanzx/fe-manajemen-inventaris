        ...
        <ul class="flex flex-row gap-6">
          <li class="flex justify-center items-center">
            <button
              ...
              @click="$router.push('/satpam/notifikasi')"
            >
              <img
                src="../assets/bell.svg"
    ...
    >
      <div class="flex flex-row justify-start items-center gap-3">
        <img
          ...
          alt=""
        />
        <span class="text-[12px] font-semibold"> Satpam Name </span>
      </div>
...
export default {
  ...
  methods: {
    ...
    goToProfile() {
      ...
      this.$router.push("/satpam/profile");
      // Tutup elemen v-show
      this.open = false;
    },
    goToNotification() {
      // Pindahkan ke halaman profil
      this.$router.push("/satpam/notifikasi");
      // Tutup elemen v-show
      this.open = false;
    },
  },
